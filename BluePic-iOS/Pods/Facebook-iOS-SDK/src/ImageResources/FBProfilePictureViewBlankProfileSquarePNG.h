 ...
 *
 *   ./image_to_code.py -i src/ImageResources/FBProfilePictureView/FBProfilePictureViewBlankProfileSquare.png -c FBProfilePictureViewBlankProfileSquare -o src/ImageResources
 *
 */
