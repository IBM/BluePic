...
/** Collation that compares only a limited number of top-level collection items.
    If the first 'arrayLimit' items of the top-level array/object have been parsed and are equal, it
   will stop and return 0. (This is useful for view result grouping.) */
