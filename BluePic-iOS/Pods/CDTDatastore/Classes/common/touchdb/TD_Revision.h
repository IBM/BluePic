...
/** Stores information about a revision -- its docID, revID, and whether it's deleted. It can also
 * store the sequence number and document contents (they can be added after creation). */
