...
+ (NSData*)dataWithJSONObject:(id)object
                      options:(NSJSONWritingOptions)options
                        error:(NSError**)error
{
    if ((options & TDJSONWritingAllowFragments) && ![object isKindOfClass:[NSDictionary class]] &&
...
+ (NSString*)stringWithJSONObject:(id)obj options:(TDJSONWritingOptions)opt error:(NSError**)error
{
...
- (id)objectAtIndex:(NSUInteger)index
{
    ...
    if ([obj isKindOfClass:[NSData class]]) {
        obj = [TDJSON JSONObjectWithData:obj options:TDJSONReadingAllowFragments error:nil];
