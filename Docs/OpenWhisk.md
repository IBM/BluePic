...
3) On that same [OpenWhisk CLI](https://new-console.ng.bluemix.net/openwhisk/cli) page, you can find the values needed to populate the `properties.json` file under the `Bluepic-Server` directory.
